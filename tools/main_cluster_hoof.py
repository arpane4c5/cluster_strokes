...
# -*- coding: utf-8 -*-
"""
Created on Sat Feb 13 03:02:08 2021

@author: arpan

@Description: main file for clustering pooled video level global stroke features (Highlights data).
"""
...
#    val_sizes = [utils.getNFrames(os.path.join(DATASET, f+".avi")) for f in val_lst]
    ...
    if ft_type == "ofgrid":
        ...
        log_dir = os.path.join(log_dir, "hoof_b"+str(nbins)+"_mth"+str(mth))
#    elif ft_type == '2dcnn':
...
#                                                       train_lst, c3dWinSize) 
    print("Extract features. Save to disk...")
...
#        base_path = "/home/arpan/DATA_Drive2/Cricket/Workspace/StrokeAttention/logs"        
    ...
    log_dir = 'data/cluster_logs/pooled_feats'
