...
class ConvGRU(nn.Module):
    ...
    def forward(self, x, hidden_state=None):
        ...
        for idx in range(self.num_layers):
            ...
            #layer_output = torch.stack([q], dim=1)
...
if __name__ == '__main__':
    crnn = ConvGRU(input_size=256, hidden_size=256, kernel_size=1, num_layers=1)
    data = torch.randn(1, 5, 256, 4, 4) # [B, seq_len, C, H, W], temporal axis=1
    output, hn = crnn(data)
    print(output.shape)
